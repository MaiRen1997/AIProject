...
class TextToImageRequestModel(BaseModel):
    ...
    batch_size: int | None = Field(default=1, description='单次生成数量')
    num_inference_steps: int | None = Field(default=20, description='推理步数')
    guidance_scale: float | None = Field(default=7.5, description='提示词引导强度')
