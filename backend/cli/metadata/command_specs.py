...
DEFAULT_COMPLETION_SHELL_SPECS: dict[str, CompletionShellSpec] = {
    'bash': CompletionShellSpec(
        ...
        generator='click',
        default_target='.local/share/rowen/completion/rowen.bash',
    ...
    'zsh': CompletionShellSpec(
        ...
        generator='click',
        default_target='.local/share/rowen/completion/rowen.zsh',
    ...
    'fish': CompletionShellSpec(
        ...
        generator='click',
        default_target='.config/fish/completions/rowen.fish',
    ...
    'powershell': CompletionShellSpec(
        ...
        generator='custom',
        default_target='Documents/PowerShell/Profile/rowen.ps1',
